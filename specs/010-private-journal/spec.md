...
- **FR-009**: Each entry MUST support these numeric responses: suicidal thoughts (0–10), self-harm thoughts (0–10), alcoholic drinks (0–10), hours of sleep (0–24 in 0.5-hour steps), urge to avoid commitments or obligations (0–100), and anger, fear, anxiety, pain, sadness, shame, guilt, loneliness, joy, and contentment (each 0–100).
